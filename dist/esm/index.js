...
const OpenStreetMapAutocomplete = ({ value, onChange, debounce = 500, placeholder = 'Search', noOptionName = 'No locations found', openStreetMapUrl = 'https://nominatim.openstreetmap.org' }) => {
    ...
    return (jsxs("div", { className: 'autocomplete', children: [jsxs("form", { className: 'autocomplete-form', onBlur: hideOptionsList, children: [jsx("div", { className: 'autocomplete-input-wrapper', children: jsx("input", { type: 'text', ref: inputRef, placeholder: placeholder, onClick: displayOptionsList, onKeyUp: handleOnAutocomplete }) }), jsx("hr", { className: 'autocomplete-divider', role: 'none' }), jsx("button", { tabIndex: 0, type: 'button', onClick: handleOnSearchClick, className: 'autocomplete-button', children: jsx("svg", { children: jsx("path", { d: 'M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z' }) }) })] }), jsx("div", { className: `autocomplete-list-wrapper ${isActive ? 'active' : ''}`, children: jsx("ul", { className: 'autocomplete-options', role: 'presentation', children: (options.length > 0
                        ? options
                        : [Object.assign(Object.assign({}, DEFAULT_OPTION), { display_name: noOptionName })]).map((option, index) => (jsx("li", { onClick: () => handleOnSelectOption(option), className: option.osm_id === (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.osm_id) ? 'selected' : '', children: option.display_name }, `${option.osm_id}-${index}`))) }) })] }));
};

export { OpenStreetMapAutocomplete };
